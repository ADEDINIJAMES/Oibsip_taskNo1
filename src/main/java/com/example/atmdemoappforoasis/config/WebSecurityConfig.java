package com.example.atmdemoappforoasis.config;


import com.example.atmdemoappforoasis.serviceImplementation.UserServiceImpl;
import com.example.atmdemoappforoasis.utils.JwtAuthenticationFilter;
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(httpRequest ->
                        httpRequest
                                ...
                                .requestMatchers("/**","/api/v1/flight/availableFlight","/api/v1/flight/search","/api/v1/flight/departing-flights", "/api/v1/flight/returning-flights").permitAll()
                                .requestMatchers("/api/v1/user/logout",
                                        "/api/v1/user/changePassword",
                                        "/api/v1/flight/add-flight",
                                        "/api/v1/flight/update-flight/{id}","/api/v1/account/**","/api/v1/transact/**").authenticated())
